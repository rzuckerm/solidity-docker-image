SOLIDITY_VERSION := $(shell cat SOLIDITY_VERSION)
SOLIDITY_DEPS := $(wildcard SOLIDITY_*) $(wildcard *_solidity)
DOCKER_TAG_PREFIX := rzuckerm/solidity:$(SOLIDITY_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(SOLIDITY_DEPS)
